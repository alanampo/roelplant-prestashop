                            ...
                            <td>
                                ...
                                <div class="radio-toolbar tvselect-theme-select" id="select_theme">
                                    ...
                                    <label for="radioTheme1" class="theme-1">
                                        <span>
                                            <svg class="primary-color" version="1.1" id="Layer_1" x="0px" y="0px" width="110px" height="65px" viewBox="0 0 89.681 47" style="enable-background:new 0 0 89.681 47;" xml:space="preserve">
                                                <polygon style="fill:#62774c;" points="0,0 0,47 64.234,47 89.681,0  " />
                                            </svg>
                                            <svg class="secondary-color" version="1.1" id="Layer_1" x="0px" y="0px" width="89.681px" height="47px" viewBox="0 0 89.681 47" style="enable-background:new 0 0 89.681 47;" xml:space="preserve">
                                                <polygon style="fill:#62774c;" points="89.681,0 25.445,0 0,47 89.681,47     " />
                                            </svg>
                                        </span>
                                        <span class="tvtheme-label">{l s='Theme 1' d='Shop.Theme.Global'}</span>
                                    </label>
                                    <input type="radio" id="radioTheme2" name="radioTheme" data-color="#ba0404" data-color-two="#e40046" value="theme2">
                                    <label for="radioTheme2" class="theme-2">
                                        <span>
                                            <svg class="primary-color" version="1.1" id="Layer_1" x="0px" y="0px" width="110px" height="65px" viewBox="0 0 89.681 47" style="enable-background:new 0 0 89.681 47;" xml:space="preserve">
                                                <polygon style="fill:#ba0404;" points="0,0 0,47 64.234,47 89.681,0  " />
                                            </svg>
                                            <svg class="secondary-color" version="1.1" id="Layer_1" x="0px" y="0px" width="89.681px" height="47px" viewBox="0 0 89.681 47" style="enable-background:new 0 0 89.681 47;" xml:space="preserve">
                                                <polygon style="fill:#ba0404;" points="89.681,0 25.445,0 0,47 89.681,47     " />
                                            </svg>
                                        </span>
                                        <span class="tvtheme-label">{l s='Theme 2' d='Shop.Theme.Global'}</span>
                                    </label>
                                    <input type="radio" id="radioTheme3" name="radioTheme" data-color="#318574" data-color-two="#185885" value="theme3">
                                    <label for="radioTheme3" class="theme-3">
                                        <span>
                                            <svg class="primary-color" version="1.1" id="Layer_1" x="0px" y="0px" width="110px" height="65px" viewBox="0 0 89.681 47" style="enable-background:new 0 0 89.681 47;" xml:space="preserve">
                                                <polygon style="fill:#318574;" points="0,0 0,47 64.234,47 89.681,0  " />
                                            </svg>
                                            <svg class="secondary-color" version="1.1" id="Layer_1" x="0px" y="0px" width="89.681px" height="47px" viewBox="0 0 89.681 47" style="enable-background:new 0 0 89.681 47;" xml:space="preserve">
                                                <polygon style="fill:#318574;" points="89.681,0 25.445,0 0,47 89.681,47     " />
                                            </svg>
                                        </span>
                                        <span class="tvtheme-label">{l s='Theme 3' d='Shop.Theme.Global'}</span>
                                    </label>
                                    <input type="radio" id="radioTheme4" name="radioTheme" data-color="#226199" data-color-two="#b89300" value="theme4">
                                    <label for="radioTheme4" class="theme-4">
                                        <span>
                                            <svg class="primary-color" version="1.1" id="Layer_1" x="0px" y="0px" width="110px" height="65px" viewBox="0 0 89.681 47" style="enable-background:new 0 0 89.681 47;" xml:space="preserve">
                                                <polygon style="fill:#226199;" points="0,0 0,47 64.234,47 89.681,0  " />
                                            </svg>
                                            <svg class="secondary-color" version="1.1" id="Layer_1" x="0px" y="0px" width="89.681px" height="47px" viewBox="0 0 89.681 47" style="enable-background:new 0 0 89.681 47;" xml:space="preserve">
                                                <polygon style="fill:#226199;" points="89.681,0 25.445,0 0,47 89.681,47     " />
                                            </svg>
                                        </span>
                    ...
                    <td>
                        ...
                        <div class="bg-block">
                            ...
                            <div class="tvbody-bgcolor-wrapper tvtheme-body-bgcolor open">
                                ...
                                <input type="text" id="themebodybgcolor" class="tvtheme-bgcolor" data-control="saturation" autocomplete="off">
