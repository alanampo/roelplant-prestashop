			...
			<div class="tab-content">
				...
				<div role="tabpanel" class="tab-pane active panel" id="tagmanager">
					<div class="panel-body">
						...
						<div class="form-group">
							<label class="control-label col-lg-3" for="CDC_GTM_GOOGLE_SCRIPTS_SERVER_URL">{l s='Google Tag Manager script URL' mod='cdc_googletagmanager'}</label>
							<div class="margin-form col-lg-3">
								<input type="url" class="form-control" id="CDC_GTM_GOOGLE_SCRIPTS_SERVER_URL" name="CDC_GTM_GOOGLE_SCRIPTS_SERVER_URL" value="{$CDC_GTM_GOOGLE_SCRIPTS_SERVER_URL|escape:'htmlall':'UTF-8'}" placeholder="https://www.googletagmanager.com/gtm.js" />
							</div>
							<div class="col-lg-6">
