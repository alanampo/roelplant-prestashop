...
class CategoryFormType extends CommonAbstractType
{
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        ...
        $resolver->setDefaults([
            'form_theme' => '@Modules/chatgptcontentgenerator/views/templates/admin/category_form.html.twig',
        ]);
    }
