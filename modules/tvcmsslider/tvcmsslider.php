    ...
    public function createDefaultData()
    {
        ...
        for ($i = 1; $i <= 2; ++$i) {
            ...
            foreach ($languages as $language) {
                $slide->title[$language['id_lang']] = 'Welcome to Growee';
                $slide->description[$language['id_lang']] = '<h2>Uncomplicate <span> Indoor</span> Gardening</h2><p>When you file a property plat with your city or county, you must follow certain rules for it to be properly recorded.</p>';
