...
class TvcmsBlog extends Module
{
    ...
    public function __construct()
    {
        ...
        parent::__construct();
        $this->displayName = $this->l('JHP Template - Blog');
    ...
    public function addQuickAccessLink()
    {
        ...
        if (isset($languages) && !empty($languages)) {
            foreach ($languages as $language) {
                $QuickAccess->name[$language['id_lang']] = $this->l("JHPTemplate Settings");
            }
        }
    ...
    public function registerETabs()
    {
        ...
        foreach ($langs as $l) {
            $tabpar_listobj->name[$l['id_lang']] = $this->l("JHPTemplate Blog");
        }
