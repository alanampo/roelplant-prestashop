  ...
  window.onload = () => {
    new Whatsapp({
      ...
      {/literal}
      	...
      	{literal}
		    {
		        name:"{/literal}{$single_agent.name}{literal}",
		        phone:"{/literal}{$single_agent.wa_number}{literal}",
		        hours:`{/literal}{$single_agent.availability}{literal}`,
		        cta:"{/literal}{$single_agent.cta}{literal}"
		    },
		{/literal}
		{/foreach}
      {literal}
