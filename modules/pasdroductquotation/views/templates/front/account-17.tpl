    ...
    <tbody>
        ...
        {assign var='msgs' value=(Quote::countMessage($quote.id_productquotation))|intval}
            <tr>
                ...
                <td>
                    <a href="{$link->getModuleLink('productquotation', 'quotations', ['id_quote' => $quote.id_quote, 'id_quotation' => $quote.id_productquotation], true)|escape:'htmlall':'UTF-8'}">{l s='More Details' mod='productquotation'}</a>

                    <a style="margin-top: -5px;" class="btn btn-default" href="{$link->getModuleLink('productquotation', 'quotations', ['pdf' => 1, 'id_quote' => $quote.id_quote, 'id_quotation' => $quote.id_productquotation], true)|escape:'htmlall':'UTF-8'}"><i class="material-icons">cloud_download</i>
                    </a>
