...
$this->refs = 'https://prestahero.com/';
        ...
        if (Tools::isSubmit('btnSubmit')) {
            ...
            if (!count($this->_errors)) {
                ...
                if(is_array($PH_SL_LINK_ENABLED) && self::validateArray($PH_SL_LINK_ENABLED))
                    Configuration::updateValue('PH_SL_LINK_ENABLED',Tools::jsonEncode($PH_SL_LINK_ENABLED));
                ...
                if(is_array($PH_SL_LINK_VALUES) && self::validateArray($PH_SL_LINK_VALUES))
                    Configuration::updateValue('PH_SL_LINK_VALUES',Tools::jsonEncode($PH_SL_LINK_VALUES));
    ...
    {
        $socials_link_enabled = Tools::getValue('PH_SL_LINK_ENABLED',Configuration::get('PH_SL_LINK_ENABLED') ? Tools::jsonDecode(Configuration::get('PH_SL_LINK_ENABLED'),true):array()) ;
        $socials_link_value = Tools::getValue('PH_SL_LINK_VALUES',Configuration::get('PH_SL_LINK_VALUES') ? Tools::jsonDecode(Configuration::get('PH_SL_LINK_VALUES'),true):array());
        $this->smarty->assign(
            array(
    ...
    public function displaySocicalBlock($position)
    {
        ...
        {
            $socials_link_enabled = Configuration::get('PH_SL_LINK_ENABLED') ? Tools::jsonDecode(Configuration::get('PH_SL_LINK_ENABLED'),true):array() ;
            $socials_link_value = Configuration::get('PH_SL_LINK_VALUES') ? Tools::jsonDecode(Configuration::get('PH_SL_LINK_VALUES'),true):array();
