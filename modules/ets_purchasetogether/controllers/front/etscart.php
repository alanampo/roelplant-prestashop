...
class Ets_purchasetogetherEtscartModuleFrontController extends ModuleFrontController
{
    ...
    */
    ...
    protected function processChangeProductInCart()
    {
        ...
        $products =  json_decode($productIds, true);
        ...
        if(is_array($products) && $products)
        {
            foreach($products as $prod)
            {
                ...
                /** check quantity product in stock and quantity up or down*/
                ...
                /** if not errors then add product to cart */
                if (!count($this->productAddeds[$key]['errors'])) 
                {
                    /** if not cart then add cart new*/
    ...
    public function displayAjax()
    {
        ...
        elseif (file_exists(_PS_MODULE_DIR_.'/ets_purchasetogether/ets_purchasetogether-ajax.php')) {
            ...
            Ets_purchasetogetherajax::Action($this->productAddeds);
        }
    }
}