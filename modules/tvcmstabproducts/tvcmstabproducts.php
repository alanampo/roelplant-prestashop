...
class TvcmsTabProducts extends Module
{
    ...
    public function __construct()
    {
        ...
        $this->displayName = $this->l('JHP Template - Tab Product Settings');
        $this->description = $this->l('It is use of Tab Setting in JHPTemplate Theme');
    ...
    public function createDefaultData()
    {
        ...
        foreach ($languages as $lang) {
            ...
            $result['TVCMSTABPRODUCTS_MAIN_SUB_TITLE'][$lang['id_lang']] = 'Plant’s Collection';
