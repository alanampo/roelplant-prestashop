...
class TvcmsCategorySlider extends Module
{
    ...
    public function __construct()
    {
        ...
        parent::__construct();
        $this->displayName = $this->l('JHP Template - Categroy Slider');
    ...
    public function createVariable()
    {
        ...
        foreach ($languages as $lang) {
            $result['TVCMSCATEGORY_SLIDER_TITLE'][$lang['id_lang']] = 'Featured Categories';
            $result['TVCMSCATEGORY_SLIDER_SUB_DESCRIPTION'][$lang['id_lang']] = 'Popular Plants Collection';
            $result['TVCMSCATEGORY_SLIDER_DESCRIPTION'][$lang['id_lang']] = 'Nam quam nunc, blandit vel, luctus pulvinar, hendrerit id, lorem.';
                ...
                foreach ($languages as $lang) {
                    $data[] = 'INSERT INTO `'._DB_PREFIX_.'tvcmscategory_slider_lang`
                            SET 
                                ...
                                title = \'Cadeau Symbolique '.$i.'\',
                                short_description = \'Autumns Featured'.$i.'\'';
                }
            } else {
                $data[] = 'INSERT INTO `'._DB_PREFIX_.'tvcmscategory_slider`
                            SET 
