...
* @author PrestaShop SA <contact@prestashop.com>
    ...
    *}
    {strip}
    <div class="tvapp-logo-link-wrapper col-xs-12">
        ...
        <div class='tvapp-logo-wrapper tvapp-logo-apple'>
            <a href='{$data.apple_link}' title='{l s="Apple App Link" mod="tvcmscustomsetting"}'>
                <img src='{$path}App-logo-1.png' alt='{l s="Apple App Link" mod="tvcmscustomsetting"}' height="41" width="145" class="tv-img-responsive">
        ...
        <div class='tvapp-logo-wrapper tvapp-logo-google'>
            <a href='{$data.google_link}' title='{l s="Google App Link" mod="tvcmscustomsetting"}'>
                <img src='{$path}App-logo-2.png' alt='{l s="Google App Link" mod="tvcmscustomsetting"}' height="41" width="145" class="tv-img-responsive">
        ...
        <div class='tvapp-logo-wrapper tvapp-logo-microsoft'>
            <a href='{$data.microsoft_link}' title='{l s="Microsoft App Link" mod="tvcmscustomsetting"}'>
                <img src='{$path}App-logo-3.png' alt='{l s="Microsoft App Link" mod="tvcmscustomsetting"}' height="41" width="145" class="tv-img-responsive">
