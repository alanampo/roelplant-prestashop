...
<p>{l s='This action will remove all the JHPTemplate modules data and add the new settings like the demo page.' mod="tvcmscustomsetting"}<br/>{l s="Please make sure you have a database backup." mod="tvcmscustomsetting"}</p>
<input type="checkbox" id="tvcmsInstallDataForm" name="tvcmsInstallDataForm">
<label for="tvcmsInstallDataForm">Overwrite the JHPTemplate module's data.</label>
