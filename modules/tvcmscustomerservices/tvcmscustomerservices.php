...
class TvcmsCustomerServices extends Module
{
    public function __construct()
    {
        ...
        $this->displayName = $this->l('JHP Template - Customer Services');
    ...
    public function createDefaultData()
    {
        ...
        foreach ($languages as $lang) {
            ...
            $result['TVCMSCUSTOMERSERVICES_SUB_DESCRIPTION'][$lang['id_lang']] = 'Features';
            $result['TVCMSCUSTOMERSERVICES_DESCRIPTION'][$lang['id_lang']] = 'Description';
            $result['TVCMSCUSTOMERSERVICES_IMG'][$lang['id_lang']] = 'demo_main_img.png';

            $result['TVCMSCUSTOMERSERVICES_SERVICES_1_IMAGE'][$lang['id_lang']] = 'demo_img_1.png';
            $result['TVCMSCUSTOMERSERVICES_SERVICES_1_CAPTION'][$lang['id_lang']] = 'Fast Low Cost Freight';
            $result['TVCMSCUSTOMERSERVICES_SERVICES_1_DESC'][$lang['id_lang']] = 'Money your card details to a much more.';
            ...
            $result['TVCMSCUSTOMERSERVICES_SERVICES_2_DESC'][$lang['id_lang']] = '100% Payment protection easy return policy';

            $result['TVCMSCUSTOMERSERVICES_SERVICES_3_IMAGE'][$lang['id_lang']] = 'demo_img_3.png';
            $result['TVCMSCUSTOMERSERVICES_SERVICES_3_CAPTION'][$lang['id_lang']] = 'Mobile Friendly';
            $result['TVCMSCUSTOMERSERVICES_SERVICES_3_DESC'][$lang['id_lang']] = 'Got a qustion? Look no further.Browse ourFAQs.';
            ...
            $result['TVCMSCUSTOMERSERVICES_SERVICES_4_DESC'][$lang['id_lang']] = 'Download the app and get exciting';
            ...
            $result['TVCMSCUSTOMERSERVICES_SERVICES_5_DESC'][$lang['id_lang']] = 'Different customers will also have different concerns.';

            $result['TVCMSCUSTOMERSERVICES_SERVICES_6_IMAGE'][$lang['id_lang']] = 'demo_img_6.png';
            $result['TVCMSCUSTOMERSERVICES_SERVICES_6_CAPTION'][$lang['id_lang']] = 'Payment Method';
            $result['TVCMSCUSTOMERSERVICES_SERVICES_6_DESC'][$lang['id_lang']] = 'A Tea is a solution of compounds in water chemically pure.';
        }
        ...
        $tmp = $result['TVCMSCUSTOMERSERVICES_SERVICES_6_IMAGE'];
        Configuration::updateValue('TVCMSCUSTOMERSERVICES_SERVICES_6_IMAGE', $tmp);
        $tmp = $result['TVCMSCUSTOMERSERVICES_SERVICES_6_CAPTION'];
        Configuration::updateValue('TVCMSCUSTOMERSERVICES_SERVICES_6_CAPTION', $tmp);
        $tmp = $result['TVCMSCUSTOMERSERVICES_SERVICES_6_DESC'];
        Configuration::updateValue('TVCMSCUSTOMERSERVICES_SERVICES_6_DESC', $tmp);
        Configuration::updateValue('TVCMSCUSTOMERSERVICES_SERVICES_6_STATUS', 1);
    }
    ...
    public function deleteVariable()
    {
        ...
        Configuration::deleteByName('TVCMSCUSTOMERSERVICES_SERVICES_6_IMAGE');
        Configuration::deleteByName('TVCMSCUSTOMERSERVICES_SERVICES_6_CAPTION');
        Configuration::deleteByName('TVCMSCUSTOMERSERVICES_SERVICES_6_DESC');
        Configuration::deleteByName('TVCMSCUSTOMERSERVICES_SERVICES_6_STATUS');
    }
    ...
    public function postProcess()
    {
        ...
        if (Tools::isSubmit('submitTvcmsCustomerServicesForm') && Tools::getValue('tvinstalldata') == "0") {
            ...
            foreach ($languages as $lang) {
                ...
                if (!empty($_FILES['TVCMSCUSTOMERSERVICES_SERVICES_6_IMAGE_'.$lang['id_lang']]['name'])) {
                    $old_file = Configuration::get('TVCMSCUSTOMERSERVICES_SERVICES_6_IMAGE', $lang['id_lang']);
                    $new_file = $_FILES['TVCMSCUSTOMERSERVICES_SERVICES_6_IMAGE_'.$lang['id_lang']];
                    $ans = $obj_image->imageUploading($new_file, $old_file);
                    if ($ans['success']) {
                        $result['TVCMSCUSTOMERSERVICES_SERVICES_6_IMAGE'][$lang['id_lang']] = $ans['name'];
                    } else {
                        $message .= $ans['error'];
                        $result['TVCMSCUSTOMERSERVICES_SERVICES_6_IMAGE'][$lang['id_lang']] = $old_file;
                    }
                } else {
                    $old_file = Configuration::get('TVCMSCUSTOMERSERVICES_SERVICES_6_IMAGE', $lang['id_lang']);
                    $result['TVCMSCUSTOMERSERVICES_SERVICES_6_IMAGE'][$lang['id_lang']] = $old_file;
                ...
                $tmp = Tools::getValue('TVCMSCUSTOMERSERVICES_SERVICES_6_CAPTION_'.$lang['id_lang']);
                $result['TVCMSCUSTOMERSERVICES_SERVICES_6_CAPTION'][$lang['id_lang']] = $tmp;
                $tmp = Tools::getValue('TVCMSCUSTOMERSERVICES_SERVICES_6_DESC_'.$lang['id_lang']);
                $result['TVCMSCUSTOMERSERVICES_SERVICES_6_DESC'][$lang['id_lang']] = $tmp;
            }
            ...
            $tmp = $result['TVCMSCUSTOMERSERVICES_SERVICES_6_DESC'];
            Configuration::updateValue('TVCMSCUSTOMERSERVICES_SERVICES_6_DESC', $tmp);
            $tmp = Tools::getValue('TVCMSCUSTOMERSERVICES_SERVICES_6_STATUS');
            Configuration::updateValue('TVCMSCUSTOMERSERVICES_SERVICES_6_STATUS', $tmp);
    ...
    protected function getConfigFormValues()
    {
        ...
        foreach ($languages as $lang) {
            ...
            $a = Configuration::get('TVCMSCUSTOMERSERVICES_SERVICES_6_IMAGE', $lang['id_lang']);
            $fields['TVCMSCUSTOMERSERVICES_SERVICES_6_IMAGE'][$lang['id_lang']] = $a;
            $a = Configuration::get('TVCMSCUSTOMERSERVICES_SERVICES_6_CAPTION', $lang['id_lang']);
            $fields['TVCMSCUSTOMERSERVICES_SERVICES_6_CAPTION'][$lang['id_lang']] = $a;
            $a = Configuration::get('TVCMSCUSTOMERSERVICES_SERVICES_6_DESC', $lang['id_lang']);
            $fields['TVCMSCUSTOMERSERVICES_SERVICES_6_DESC'][$lang['id_lang']] = $a;
        }
        ...
        $tmp = Configuration::get('TVCMSCUSTOMERSERVICES_SERVICES_6_STATUS');
        $fields['TVCMSCUSTOMERSERVICES_SERVICES_6_STATUS'] = $tmp;
    ...
    public function showFrontData()
    {
        ...
        $tempStatus = Configuration::get('TVCMSCUSTOMERSERVICES_SERVICES_6_STATUS');
        if (!empty($tempStatus) && $tempStatus == 1) {
            $tmp = Configuration::get('TVCMSCUSTOMERSERVICES_SERVICES_6_IMAGE', $id_lang);
            $result['service_6']['image'] = $tmp;
            $tmp = Configuration::get('TVCMSCUSTOMERSERVICES_SERVICES_6_CAPTION', $id_lang);
            $result['service_6']['title'] = $tmp;
            $tmp = Configuration::get('TVCMSCUSTOMERSERVICES_SERVICES_6_DESC', $id_lang);
            $result['service_6']['desc'] = $tmp;
            $result['service_6']['status'] = $tempStatus;
        }
