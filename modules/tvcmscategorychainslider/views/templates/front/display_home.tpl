                ...
                <div class='tvcategory-chain-slider-content-box owl-theme owl-carousel'>
                    ...
                    <div class="item tvcategory-chain-slider-wrapper-info">
                        <div class="tvcategory-chain-slider-wrapper clearfix tvcategory-chain-slider-info-wrapper">
                            <div class="tvcategory-chin-img-block">
                            ...
                            <div class="tvcategory-chain-content-wrapper">
                                ...
                                {if $count <= 4} <a href="{$link->getCategoryLink($cat_info['id_category'])}" title="{$cat_info['name']}" class="tvcategory-chain-slider-category">
                                    {$cat_info['name']}
                                    </a>
                                    {$count = $count + 1}
                                    {else}
                                    ...
                                    {/if}
                                    {/foreach}
                                    <a class="tvcategory-chain-slider-all-link btn {* tvall-inner-btn *}" href="{$link->getCategoryLink($data['id_category'])}" title="{$data['title']}">
