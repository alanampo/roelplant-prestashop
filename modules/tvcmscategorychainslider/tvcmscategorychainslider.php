...
class TvcmsCategoryChainSlider extends Module
{
    ...
    public function __construct()
    {
        ...
        parent::__construct();
        $this->displayName = $this->l('JHP Template - Categroy Chain Slider');
    ...
    public function createVariable()
    {
        ...
        foreach ($languages as $lang) {
            ...
            $result['TVCMSCATEGORY_CHAIN_SLIDER_SUB_DESCRIPTION'][$lang['id_lang']] = 'Most Popular Creation';
