...
*}
<div class="modal fade js-product-images-modal{if (isset($tc_config.YBC_TC_PRODUCT_LAYOUT) && $tc_config.YBC_TC_PRODUCT_LAYOUT == 'layout2')} images-thumb-right{else if (isset($tc_config.YBC_TC_PRODUCT_LAYOUT) && $tc_config.YBC_TC_PRODUCT_LAYOUT == 'layout1')} images-thumb-left{else} images-thumb-horizona{/if}" id="product-modal">
